...
export const setFirebaseInitStatus = (state: boolean) => (dispatch: Dispatch<Action>) => {
	const payload: ContentState = initialize;
	payload.isFirebaseInited = state;

	dispatcher(ActionType.CONTENT_FIREBASE_INIT, payload, dispatch);
};
