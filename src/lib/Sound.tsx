...
export const fadeOutMusic = (musicVolume: number) => {
...
export const fadeInMusic = (musicVolume: number) => {
...
export function playNoteSound(note: Note, volume: number = 1, noteSoundType: "piano" | "oscillator" = "piano", oscillatorType: OscillatorType = "sine") {
	...
	if (noteSoundType === "oscillator" || !pianoSampler?.loaded) {
