...
const Background = ({ ...props }: IBackground) => {
	...
	return (
		<>
			...
			<div
				className={cn("main-bg-video main-bg-opacity transition-all duration-1000 select-none overflow-hidden -z-10 fixed inset-0", props.blurBackground ? "blur-xl scale-110" : "blur-0")}
				ref={mainVideoRef}
			/>
